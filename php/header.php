      ...
      <div class="rowe">
        ...
        <nav class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            <li class="dropdown">
              <a href="#" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >HOME</a>
            </li>
            <li class="dropdown">
              <a href="#" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SERVICES</a>
            </li>
            <li class="dropdown">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><div class="fa fa-user"></div> SIGN IN / SIGN UP </a>
            </li>
          </ul>
        </nav>
      </div>
