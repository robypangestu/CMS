          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <?php if (isset($_SESSION['admin']) ) { ?>
                <a href="admin/layanan/layanan.php" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><div class="fa fa-user"></div> Akun </a>
              <?php } else if (isset($_SESSION['pelanggan']) ) { ?>
                <a href="pelanggan/transaksi/transaksi.php" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><div class="fa fa-user"></div> Akun </a>
              <?php } else { ?>
                <a href="login.php" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><div class="fa fa-user"></div> SIGN IN / SIGN UP </a>
              <?php } ?>
            </li>
          </ul>
        </nav>
