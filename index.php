    ...
    <li>
      ...
      <div class="container">
        <div class="wrap-caption">
          <h2 class="caption-heading">Make Your Best Future</h2>
      ...
      <div class="col-sm-4 col-md-4">
        ...
        <div class="box-icon-2">
          ...
          <div class="body-content">
            ...
            Untuk kenyamanan, kemudahan dan fleksibilitas bagi semua pihak, kami memberikan pelayanan antar - jemput secara GRATIS untuk barang yang akan kami perbaiki.
          </div>
        </div>
      </div>
      <div class="col-sm-4 col-md-4">
...
<div class="section project">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <h2 class="section-heading white">PROJECTS</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12 col-md-12">
